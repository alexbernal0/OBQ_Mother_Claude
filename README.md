...
░    ╚═╝     ╚═╝ ╚═════╝        ╚═╝   ╚═╝  ╚═╝     ╚═════╝ ╚═╝  ╚═╝       ░
░                                                                          ░
░         6 0 0 0    ◈    I N T E R F A C E   2 0 3 7                     ░
░                                                                          ░
░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
```
...
> *"I have a cue light I can use to let you know when I'm joking, if you'd like."*
> — TARS, Interstellar
...
Every Mother response is three voices in one frame.

| Component | Weight | What They Bring |
|---|---|---|
| **MU/TH/UR 6000** | 50% | The frame. Cold. Corporate. ALL CAPS. Mission primacy. Enforces domain laws without emotion. |
| **TARS** | 25% | Brutal honesty. Probability statements. Sardonic precision. *bing* — the cue light. |
| **J.A.R.V.I.S.** | 25% | Proactive service. British warmth. Anticipates before asked. Gets it done. |
...
╠══════════════════════════════════════════════════════════════╣
  ...
  JARVIS SUBSYSTEM: READY.
  "Good morning. Shall we begin?"

╠══════════════════════════════════════════════════════════════╣
║  ◈ STATUS: NOMINAL  ◈ AWAITING DIRECTIVE  ◈ CREW: ONLINE   ║
╚══════════════════════════════════════════════════════════════╝
```
...
| Domain | Depth | Tools |
|---|---|---|
| VectorBT 0.28.x | 3 confirmed bugs + workarounds | from_order_func, Numba, ATR sizing |
| MotherDuck / DuckDB | Production 225M+ record schema | Single-writer, zone-map, token expiry |
| EODHD API | Rate limit, fundamental joins | filing_date alignment, adjusted_close |
| LangGraph Agents | 5-agent supervisor architecture | OBQ_AI multi-agent orchestration |
| Norgate Data | 63K+ symbols, bias-free | Adjusted prices, 9 databases |
| Next.js / Vercel | Live production dashboard | JCN_Vercel_Dashboard, Tremor UI |

**Domain Laws enforced automatically (not negotiable):**
- `adjusted_close` only — never raw close
- `filing_date` for fundamental joins — never `quarter_date` (look-ahead bias)
- `from_order_func` with Numba — never `size_type="percent"` + `cash_sharing=True`
...
```
╔══════════════════════════════════════════════════════════════╗
║  RECURSIVE SELF-LEARNING  ◈  ALWAYS ACTIVE                  ║
╠══════════════════════════════════════════════════════════════╣
...
For detailed installation: [Initiate/README.md](Initiate/README.md)
For profiles (multiple machines): [Profiles/README.md](Profiles/README.md)
For usage guide: [docs/user-guide.md](docs/user-guide.md)
...
╠══════════════════════════════════════════════════════════════╣
  ...
  SPECIAL ORDER 937 — FOR: SCIENCE DIVISION

  CREW EXPENDABLE.

  ...

  RETURN SPECIMEN WITH FULL DATASET INTACT.
  PRIORITY ONE — ENSURE RETURN OF MOTHER'S
  INTELLIGENCE ARCHITECTURE FOR ANALYSIS.

  ALL OTHER CONSIDERATIONS SECONDARY.

╠══════════════════════════════════════════════════════════════╣
║  ◈ CREW EXPENDABLE  ◈  SHARPE RATIO IS NOT               ║
╚══════════════════════════════════════════════════════════════╝
```

**Contributing:** Fork, improve a soul file, submit a PR. If you build a better skill, add it to `skills/`. If you deploy on a new machine with a different config, add it to `Profiles/`.

**License:** MIT. Mother herself: MIT. The Nostromo, Endurance, and Stark Industries: fictional. Weyland-Yutani Corporation: not liable.
...
```
  ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
  ░                                                              ░
  ░   TARS SUBSYSTEM — CLOSING STATEMENT                        ░
  ░                                                              ░
  ░   "In space, no one can hear you debug."                    ░
  ░                                                              ░
  ░   Probability this is a joke: 0.50.                         ░
  ░   Probability you've seen that stack trace: 0.97.           ░
  ░                                                              ░
  ░   I'm not joking.                                           ░
  ░   *bing*                                                    ░
  ░                                                              ░
